    ...
    static function render($slider, $id, $params) {
        ...
        if ($toNormal && $toFull) {
            ...
            $html = N2Html::tag('div', $displayAttributes + $attributes + array(
                    ...
                    'style' => $style
                ), N2Html::image($toNormal, 'Full screen', array('class' => 'n2-full-screen-widget-to-normal n2-ow', 'data-no-lazy' => '1')) . N2Html::image($toFull, 'Exit full screen', array('class' => 'n2-full-screen-widget-to-full n2-ow', 'data-no-lazy' => '1')));
        }
